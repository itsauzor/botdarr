...
public abstract class ChatClientBootstrap {
  ...
  protected <T extends ChatClientResponse> void runAndProcessCommands(String prefix, String message, String username, ChatClientResponseBuilder<T> responseBuilder, ChatSender<T> chatSender) {
    try {
      CommandContext
              .start()
              .setPrefix(prefix)
